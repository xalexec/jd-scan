...
public final class Constant {
    ...
    public final static String CHECK_LOGION_URL = "https://passport.jd.com/loginservice.aspx?method=Login&callback=jsonpLogin";

    public final static String QR_URL = "https://qr.m.jd.com/show?appid=133&size=147&t=";
    public final static String QR_CHECK_URL = "https://qr.m.jd.com/check";
    public final static String QR_TICKET_VALIDATION_URL = "https://passport.jd.com/uc/qrCodeTicketValidation";
    public final static String GOODS_URL = "https://item.jd.com/%s.html";

    public final static String STOCK_URL = "http://c0.3.cn/stock";
    public final static String STOCKS_URL = "http://c0.3.cn/stocks";
    ...
    public final static String CART_URL = "https://cart.jd.com/gate.action?pid=%s&pcount=1&ptype=1";
    public final static String CHANGE_CART_URL = "https://cart.jd.com/changeNum.action";

    public final static String FTQQ_URL = "https://sc.ftqq.com/%s.send";
